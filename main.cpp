...
//bool caca(Reserva res[], Material *mat[], int i, int j, int cont2, Fecha temp)
//{
//    while ((temp < res[i].getFechaReservacion() || temp > res[i].calculaFechaFinReserva(mat[j]->cantidadDiasPrestamo())) && (cont2 != 60))
//    {
//        return false;
//    }
//    return true;
